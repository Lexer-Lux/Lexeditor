...
server = Path("games/terraria/server.py")
...
Path("tests/test_terraria_structured_content_service.py").write_text(r'''from __future__ import annotations
