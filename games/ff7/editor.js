  ...
  const labels={accessories:"Accessories",armor:"Armor",characters:"Characters",initialState:"New game",initialInventory:"Starting inventory",initialMateria:"Starting Materia",stolenMateria:"Yuffie stolen Materia",commands:"Commands",playerAttacks:"Player attacks",limitBreaks:"Limit breaks",magicOrder:"Magic menu",items:"Items",itemSortOrder:"Name sort",materia:"Materia",materiaEquipEffects:"Equip effects",materiaPriority:"Menu priority",apMultiplier:"Master sale price",weapons:"Weapons",enemies:"Enemies",encounters:"Encounters",shops:"Shops",prices:"Prices",texts:"Text",exeText:"Executable text",audioMixing:"Audio mixing",enemyAttacks:"Enemy attacks",tweaks:"Tweaks",deployment:"Deployment",characterNames:"Initial names",growthCurves:"Growth curves",growthBonuses:"Growth bonuses",characterAI:"Character AI",enemyAI:"Enemy AI",formationAI:"Formation AI",recruits:"Recruits",defaultNames:"Default names",fieldEncounters:"Field encounters",worldEncounters:"World encounters",yuffieEncounters:"Yuffie encounters",chocoboRatings:"Chocobo ratings"};
  ...
  function datasetStatus(){
    ...
    return el("span",{class:"ff7-dataset-status",title:String(source||"Loaded game data")},el("span",{},status));
  }
