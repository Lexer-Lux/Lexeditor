...
def check() -> list[str]:
    ...
    for relative in (
        ...
        "item_prices.py", "auto_ability_prices.py", "ctb_base.py", "mix_table.py", "item_shops.py", "gear_shops.py",
        "ffx_commands.py", "ffx2_abilities.py", "ffx2_accessories.py", "project-template/README.md",
    ):
