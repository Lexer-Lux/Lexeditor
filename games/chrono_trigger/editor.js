...
function spriteAssemblyDetail(row){return detailPanel({className:"ct-detail",title:`Frame ${row.frameId} · tile ${row.tileId}`,identity:recordId(row.fileId),meta:row.path,body:[
