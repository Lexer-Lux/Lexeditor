...
const state={tab:"text",source:"mine",busy:true,error:"",dashboard:null,dataMap:{rows:[]},changes:[],language:"en",textFiles:[],textPath:"",text:{rows:[]},paletteFiles:[],palettePath:"",palette:{rows:[]},scenes:{rows:[]},areaMode:"settings",sceneMapFiles:[],sceneMapPath:"",sceneMap:{rows:[]},sceneProps:{rows:[]},sceneRender:{token:""},worlds:{rows:[]},worldMode:"settings",worldFiles:[],worldFilePath:"",worldMap:{rows:[]},worldProps:{rows:[]},worldMusic:{rows:[]},worldColors:{rows:[]},worldNavigation:{rows:[]},animations:{rows:[]},graphicsSets:{rows:[]},assemblies:{rows:[]},spriteHeaders:{rows:[]},tileMode:"animations",exits:{rows:[]},treasure:{rows:[]},dirty:new Map(),selected:{text:null,scenes:null,scenemaps:null,sceneprops:null,worlds:null,worldmaps:null,worldprops:null,worldmusic:null,worldcolors:null,worldnav:null,animations:null,tilesets:null,assemblies:null,sprites:null,exits:null,treasure:null,palettes:null},page:{text:0,scenes:0,scenemaps:0,sceneprops:0,worlds:0,worldmaps:0,worldprops:0,worldmusic:0,worldcolors:0,worldnav:0,animations:0,tilesets:0,assemblies:0,sprites:0,exits:0,treasure:0,palettes:0},pageSize:{text:18,scenes:18,scenemaps:18,sceneprops:18,worlds:18,worldmaps:18,worldprops:18,worldmusic:18,worldcolors:18,worldnav:18,animations:18,tilesets:18,assemblies:18,sprites:18,exits:18,treasure:18,palettes:18},query:{text:"",scenes:"",scenemaps:"",sceneprops:"",worlds:"",worldmaps:"",worldprops:"",worldmusic:"",worldcolors:"",worldnav:"",animations:"",tilesets:"",assemblies:"",sprites:"",exits:"",treasure:"",palettes:""},sort:{text:{key:"key",dir:1},scenes:{key:"id",dir:1},scenemaps:{key:"layer",dir:1},sceneprops:{key:"startTile",dir:1},worlds:{key:"id",dir:1},worldmaps:{key:"layer",dir:1},worldprops:{key:"tileIndex",dir:1},worldmusic:{key:"index",dir:1},worldcolors:{key:"index",dir:1},worldnav:{key:"tableId",dir:1},animations:{key:"fileId",dir:1},tilesets:{key:"id",dir:1},assemblies:{key:"tileId",dir:1},sprites:{key:"id",dir:1},exits:{key:"sceneId",dir:1},treasure:{key:"sceneId",dir:1},palettes:{key:"index",dir:1}},mapPage:0,mapQuery:"",mapStatus:"",mapSort:["filename",1],exportResult:null};
...
function sceneRenderView(){return panelLayout([sceneRenderDetail(state.sceneRender)],"ct-layout",{layoutKey:"chrono-scene-render",defaultSizes:[100]})}
...
function spriteDetail(row){const body=[
...
]}));return detailPanel({className:"ct-detail",title:`Sprite ${row.id}`,identity:recordId(row.id),meta:row.path,body})}
...
function tilesView(){if(state.tileMode==="tilesets")return graphicsSetsView();if(state.tileMode==="assemblies")return assembliesView();if(state.tileMode==="sprites")return spritesView();return animationsView()}
function tileToolbar(){const select=el("select",{"aria-label":"Tile data",onchange:event=>switchTileMode(event.target.value)},
  ...[["animations","Animations"],["tilesets","Graphics sets"],["assemblies","Assemblies"],["sprites","Sprite descriptors"]].map(([value,label])=>{const option=el("option",{value},label);option.selected=value===state.tileMode;return option}));
