...
const state={tab:"text",source:"mine",busy:true,error:"",dashboard:null,dataMap:{rows:[]},changes:[],language:"en",textFiles:[],textPath:"",text:{rows:[]},paletteFiles:[],palettePath:"",palette:{rows:[]},scenes:{rows:[]},worlds:{rows:[]},worldNavigation:{rows:[]},animations:{rows:[]},graphicsSets:{rows:[]},assemblies:{rows:[]},tileMode:"animations",exits:{rows:[]},treasure:{rows:[]},dirty:new Map(),selected:{text:null,scenes:null,worlds:null,worldnav:null,animations:null,tilesets:null,assemblies:null,exits:null,treasure:null,palettes:null},page:{text:0,scenes:0,worlds:0,worldnav:0,animations:0,tilesets:0,assemblies:0,exits:0,treasure:0,palettes:0},pageSize:{text:18,scenes:18,worlds:18,worldnav:18,animations:18,tilesets:18,assemblies:18,exits:18,treasure:18,palettes:18},query:{text:"",scenes:"",worlds:"",worldnav:"",animations:"",tilesets:"",assemblies:"",exits:"",treasure:"",palettes:""},sort:{text:{key:"key",dir:1},scenes:{key:"id",dir:1},worlds:{key:"id",dir:1},worldnav:{key:"tableId",dir:1},animations:{key:"fileId",dir:1},tilesets:{key:"id",dir:1},assemblies:{key:"tileId",dir:1},exits:{key:"sceneId",dir:1},treasure:{key:"sceneId",dir:1},palettes:{key:"index",dir:1}},mapPage:0,mapQuery:"",mapStatus:"",mapSort:["filename",1],exportResult:null};
...
function tileToolbar(){const select=el("select",{onchange:event=>switchTileMode(event.target.value)},
