...
const state={tab:"text",source:"mine",busy:true,error:"",dashboard:null,dataMap:{rows:[]},changes:[],language:"en",textFiles:[],textPath:"",text:{rows:[]},paletteFiles:[],palettePath:"",palette:{rows:[]},scenes:{rows:[]},areaMode:"settings",sceneMapFiles:[],sceneMapPath:"",sceneMap:{rows:[]},sceneProps:{rows:[]},worlds:{rows:[]},worldMode:"settings",worldFiles:[],worldFilePath:"",worldMap:{rows:[]},worldProps:{rows:[]},worldMusic:{rows:[]},worldColors:{rows:[]},worldNavigation:{rows:[]},animations:{rows:[]},graphicsSets:{rows:[]},assemblies:{rows:[]},tileMode:"animations",exits:{rows:[]},treasure:{rows:[]},dirty:new Map(),selected:{text:null,scenes:null,scenemaps:null,sceneprops:null,worlds:null,worldmaps:null,worldprops:null,worldmusic:null,worldcolors:null,worldnav:null,animations:null,tilesets:null,assemblies:null,exits:null,treasure:null,palettes:null},page:{text:0,scenes:0,scenemaps:0,sceneprops:0,worlds:0,worldmaps:0,worldprops:0,worldmusic:0,worldcolors:0,worldnav:0,animations:0,tilesets:0,assemblies:0,exits:0,treasure:0,palettes:0},pageSize:{text:18,scenes:18,scenemaps:18,sceneprops:18,worlds:18,worldmaps:18,worldprops:18,worldmusic:18,worldcolors:18,worldnav:18,animations:18,tilesets:18,assemblies:18,exits:18,treasure:18,palettes:18},query:{text:"",scenes:"",scenemaps:"",sceneprops:"",worlds:"",worldmaps:"",worldprops:"",worldmusic:"",worldcolors:"",worldnav:"",animations:"",tilesets:"",assemblies:"",exits:"",treasure:"",palettes:""},sort:{text:{key:"key",dir:1},scenes:{key:"id",dir:1},scenemaps:{key:"layer",dir:1},sceneprops:{key:"startTile",dir:1},worlds:{key:"id",dir:1},worldmaps:{key:"layer",dir:1},worldprops:{key:"tileIndex",dir:1},worldmusic:{key:"index",dir:1},worldcolors:{key:"index",dir:1},worldnav:{key:"tableId",dir:1},animations:{key:"fileId",dir:1},tilesets:{key:"id",dir:1},assemblies:{key:"tileId",dir:1},exits:{key:"sceneId",dir:1},treasure:{key:"sceneId",dir:1},palettes:{key:"index",dir:1}},mapPage:0,mapQuery:"",mapStatus:"",mapSort:["filename",1],exportResult:null};
...
function scenePropertyDetail(row){const directions=[[0,"North"],[1,"South"],[2,"East"],[3,"West"]];return detailPanel({className:"ct-detail",title:`Run ${row.runId} · tiles ${row.startTile}-${row.endTile}`,identity:recordId(row.mapId),meta:state.sceneProps.path||"",body:[
...
function areasSurface(){if(state.areaMode==="map")return sceneMapsView();if(state.areaMode==="properties")return scenePropsView();return scenesView()}
function areaToolbar(){const mode=el("select",{"aria-label":"Area data",onchange:event=>switchAreaMode(event.target.value)},
  ...[["settings","Settings"],["map","Map tiles"],["properties","Tile properties"]].map(([value,label])=>{const option=el("option",{value},label);option.selected=value===state.areaMode;return option}));
