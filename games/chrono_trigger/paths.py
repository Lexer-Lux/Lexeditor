...
def check() -> list[str]:
    ...
    for relative in (
        ...
        "field_semantics.py", "event_edit.py", "field_editors.py", "scene_tables.py", "scene_maps.py",
        "scene_render.py", "worlds.py", "world_tables.py", "world_scripts.py", "world_render.py",
