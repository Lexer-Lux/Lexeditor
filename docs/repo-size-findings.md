...
**Redundant FFNx backups, 115 MB, untracked.** `plugins/ff8/ffnx_issue_51/package/`
...
`plugins/rdr2/assets/item-icons`, several individual files at 1.7-1.9 MB. These
