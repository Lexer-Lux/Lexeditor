...
for token in (
    ...
    "lex-field-readonly-lock",
    # The heading is still the top tenth wherever a tenth is enough to hold it.
    # It is floored at its own min-content because in a short panel that tenth
    # was thinner than the record name plus its source line, and the heading -
    # which clips - cut both in half.
    'grid-template-rows:minmax(min-content, 10%) minmax(0,1fr)',
):
