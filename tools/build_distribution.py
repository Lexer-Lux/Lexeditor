...
VENDORED_HELPERS=(
    ...
    'shaders/reshade/LexerianDepth.fxh',
    'shaders/reshade/Colors.fx',
    'shaders/reshade/Bloom.fx',
    'shaders/reshade/Sharpen.fx',
    'shaders/reshade/AmbientOcclusion.fx',
    'shaders/reshade/DepthOfField.fx',
    'shaders/reshade/Vignette.fx',
    'shaders/reshade/Compare.fx',
