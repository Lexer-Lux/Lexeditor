...
p = Path('games/ff9/battle_scene.py')
s = p.read_text(encoding='utf-8')
start = s.index('# Memoria v2025.07.04, Assembly-CSharp/Global/BTL_SCENE.cs:')
end = s.index('\n\nclass BattleScene:', start)
block = r'''# Memoria v2025.07.04, Assembly-CSharp/Global/BTL_SCENE.cs.
