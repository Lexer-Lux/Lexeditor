...
def main() -> int:
    ...
    try:
        ...
        source = """
          window.__testSettings={developerMode:true,developerAuthorized:true,developerLogin:'Lexer-Lux',hoverableAltClick:false,selectionHoldMs:650,tableRowsPerPage:15,panelGapPercent:1,residentHandleWidthPercent:5,mainMenuHeightPercent:9,soundEnabled:true,soundVolumePercent:50,absentGameDesaturationPercent:75,globalMessageRarity:3,loadingTransitionMinimumSeconds:1.5,viewPreferences:{},updateCheckFrequency:'daily',updateCheckChoices:[{value:'daily',label:'Daily'},{value:'weekly',label:'Weekly'}],defaultValues:{hoverableAltClick:false,selectionHoldMs:650,tableRowsPerPage:15,panelGapPercent:1,residentHandleWidthPercent:5,mainMenuHeightPercent:9,soundEnabled:true,soundVolumePercent:50,absentGameDesaturationPercent:75,globalMessageRarity:3,loadingTransitionMinimumSeconds:1.5,updateCheckFrequency:'daily'},helpers:[]};
