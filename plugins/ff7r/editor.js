  ...
  function dataPreferences(){
    ...
    const prefs=columnPreferences(`ff7r-records:${asset}`,dataTableColumns(),()=>render());
  ...
  const editHistory=new EditHistory({
    capture:()=>({
      ...
      text:Object.fromEntries(textPacks().map(pack=>[pack.item.asset,clone(pack.data.records)])),
