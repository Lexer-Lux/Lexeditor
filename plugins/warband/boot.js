  const shell=LexeditorUI.mountShell({
    ...
    tabs:[["factions","Factions"],["items","Items"],["misc","Misc."],["music","Music"],["skills","Skills"],["sounds","Sounds"],["upgrades","Troop Trees"],["troops","Troops"],["tweaks","Tweaks"]].map(([id,label])=>({id,label})),
