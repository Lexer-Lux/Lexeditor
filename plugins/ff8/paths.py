...
def check() -> list[str]:
    ...
    for relative in (
        ...
        "world_map.py", "world_geometry.py", "world_textures.py", "world_data_merge.py", "field_data.py", "field_background.py", "field_dialogue.py", "field_encounters.py", "field_scripts.py", "field_walkmesh.py", "kernel_text.py", "mngrp_text.py", "refine_tables.py", "namedic.py", "wm2field.py",
