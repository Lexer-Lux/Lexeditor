  ...
  const views={cards:renderCards,abilities:renderAbilities,starting:renderStartingData,items:renderItems,refine:renderRefine,shops:renderShops,weapons:renderWeapons,magic:()=>renderKernel("magic","Magic"),gfs:renderGFs,characters:renderCharacters,text:renderText,names:renderNames,enemies:renderEnemies,encounters:renderEncounters,fields:renderFields,world:renderWorldMap,settings:renderSettings,sfx:renderSfx,models:renderModels,textures:renderTextures,datamap:renderDataMap,dashboard:renderDashboard};
