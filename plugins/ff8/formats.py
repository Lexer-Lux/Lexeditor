...
def wm2field_rows(dataset: str = "current") -> dict:
    """The world-to-field table: where a world position sends the player."""
    return wm2field.rows(dataset)


def save_wm2field(edits: list[dict]) -> dict:
...
def data_map_rows() -> dict:
    rows = [
        {"filename": "kernel.bin", "controls": "Characters, Magic, GFs, weapons, battle items, commands, abilities, linked names", "notes": "Editable: named fields and all linked text. Locked: unnamed numeric fields.", "status": "partial"},
        {"filename": "menu/price.bin", "controls": "Item buy prices and sell multipliers", "notes": "Editable: all fields.", "status": "integrated"},
        {"filename": "menu/shop.bin", "controls": "Shop inventories and rare-stock flags", "notes": "Editable: all fields.", "status": "integrated"},
        {"filename": "menu/mwepon.bin", "controls": "Weapon upgrade prices and ingredients", "notes": "Editable: all fields.", "status": "integrated"},
        ...
        {"filename": "ff8/en/exe/battle_scans.msd", "controls": "All 160 Scan descriptions", "notes": "Editable: all entries.", "status": "integrated"},
