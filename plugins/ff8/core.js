  ...
  const state={booting:true,modOnly:false,tab:"items",status:"Loading…",dashboard:null,datamap:null,editorSettings:null,mods:{rows:[],composition:{}},activeSource:"mine",
    data:{cards:null,items:null,menuItems:null,shops:null,weapons:null,magic:null,gfs:null,characters:null,text:null,enemies:null,enemyTables:null,enemyAi:null,enemyBattleText:null,refine:null,encounters:null,world:null,fields:null,init:null,settings:null},base:{},vanilla:{},references:[],referenceData:{},platformConfig:null,savedPlatformConfig:null,reshade:null,platformQuery:"",settingsTab:"gameplay",enemyPanelTab:"stats",enemyAiView:"structure",mapsTab:"field",worldTab:"map",refineTab:"m000",fieldScriptSelection:{},fieldWalkmeshSelection:{},fieldBackgroundSelection:{},fieldBackgroundPreview:{},
