  ...
  const state={booting:true,modOnly:false,tab:"items",status:"Loading…",dashboard:null,datamap:null,editorSettings:null,mods:{rows:[],composition:{}},activeSource:"mine",
    ...
    selected:{cards:null,abilityJunction:null,abilityCommand:null,abilityStat:null,abilityCharacter:null,abilityParty:null,abilityGf:null,abilityMenu:null,items:null,shops:null,weapons:null,magic:null,gfs:null,characters:null,text:null,names:null,enemies:null,refine:null,encounters:null,encounterGroups:null,encounterRule:null,world:null,fields:null,sfx:null,models:null,textures:null,startingCharacter:0,startingGf:0},startingTab:"general",
    pages:{cards:0,abilityJunction:0,abilityCommand:0,abilityStat:0,abilityCharacter:0,abilityParty:0,abilityGf:0,abilityMenu:0,items:0,shops:0,weapons:0,magic:0,gfs:0,characters:0,text:0,names:0,enemies:0,refine:0,encounters:0,encounterGroups:0,world:0,fields:0,sfx:0,models:0,textures:0,startingMagic:0,startingInventory:0,datamap:0},
    pageSizes:{cards:15,abilityJunction:15,abilityCommand:15,abilityStat:15,abilityCharacter:15,abilityParty:15,abilityGf:15,abilityMenu:15,items:15,shops:15,weapons:15,magic:15,gfs:15,characters:15,text:15,names:15,enemies:15,refine:15,encounters:15,encounterGroups:15,world:15,fields:15,sfx:15,models:15,textures:15,startingMagic:12,startingInventory:15},
    filters:{cards:"",abilityJunction:"",abilityCommand:"",abilityStat:"",abilityCharacter:"",abilityParty:"",abilityGf:"",abilityMenu:"",items:"",shops:"",weapons:"",magic:"",gfs:"",characters:"",text:"",names:"",enemies:"",refine:"",encounters:"",encounterGroups:"",world:"",fields:"",sfx:"",models:"",textures:"",datamap:"",mapStatus:""},
    sorts:{cards:["name",1],items:["name",1],shops:["name",1],weapons:["name",1],magic:["name",1],gfs:["name",1],characters:["name",1],text:["sectionId",1],names:["id",1],enemies:["name",1],refine:["id",1],encounters:["id",1],encounterGroups:["id",1],world:["id",1],fields:["mapId",1],sfx:["id",1],models:["name",1],textures:["name",1],datamap:["filename",1],abilityJunction:["name",1],abilityCommand:["name",1],abilityStat:["name",1],abilityCharacter:["name",1],abilityParty:["name",1],abilityGf:["name",1],abilityMenu:["name",1]},gfSorts:{compatibility:["label",1],abilities:["ability",1]},enemyTableSorts:{},encounterSlotSort:["slot",1],columnPrefs:{},formula:{weaponId:0,strength:80,vitality:40,luck:20,eva:15,targetLuck:10,flying:true,float:false}};
  ...
  const editableDatasets=["battleItems","ammoEffects","cards","items","menuItems","shops","weapons","magic","gfs","characters","abilityJunction","abilityCommand","abilityStat","abilityCharacter","abilityParty","abilityGf","abilityMenu","text","names","enemies","enemyTables","enemyAi","enemyBattleText","refine","encounters","world","fields","sfx","models","textures"];
