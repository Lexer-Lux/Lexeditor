  ...
  // A cell renderer must give the swatch a box of its own: an empty span has no
  // width or height, so the Sky gradient column drew nothing at all. The label
  // repeats the three colours, so the gradient is readable without seeing it.
  function worldSkySwatch(row){
    ...
    return el("span",{class:"world-sky-swatch",
      ...
      style:"display:block;width:100%;min-width:72px;height:22px;border-radius:3px;"
        +"border:1px solid var(--lex-border);box-shadow:inset 0 0 0 1px rgb(0 0 0 / .35);"
