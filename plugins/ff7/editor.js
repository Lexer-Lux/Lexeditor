  ...
  const groups={characters:["characters","characterNames","growthCurves","growthBonuses","characterAI","recruits","defaultNames"],initialState:["initialState","initialInventory","initialMateria","stolenMateria"],commands:["commands","playerAttacks","limitBreaks","magicOrder"],items:["items","keyItems"],materia:["materia","materiaEquipEffects","materiaPriority","apMultiplier"],enemies:["enemies","enemyAttacks","enemyAI"],encounters:["encounters","formationAI","fieldEncounters","worldEncounters","yuffieEncounters","chocoboRatings","worldMovement"],shops:["shops","prices"],texts:["texts","exeText"]};
