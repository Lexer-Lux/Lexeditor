...
PROJECT = {
    "root": "C:/fixture",
    "projectFile": {
        "path": "C:/fixture/Fixture.csproj",
        "name": "Fixture.csproj",
        "sdk": "Microsoft.NET.Sdk",
        "properties": {"TargetFramework": "net472", "AssemblyName": "Fixture", "Nullable": "disable"},
        "propertyRows": [],
        "editableProperties": ["TargetFramework", "AssemblyName", "Nullable"],
        "references": [],
        "packages": [],
        "items": [],
...
MODULE_DATA_BAD = {
    ...
    "elements": [
        ...
        ], "missingRequired": [{"name": "id", "required": True, "schemaType": "string", "choices": [], "kind": "text"}], "schemaIssues": ["Missing required attribute: id"]},
    ],
...
MODULE_DATA_FIXED = {
    **MODULE_DATA_BAD,
    ...
    "elements": [
        ...
        {"index": 1, "path": "Items[0]/Item[0]", "tag": "Item", "depth": 1, "line": 2, "hint": "browser_fixture", "attributes": [
            {"name": "Type", "value": "Weapon", "kind": "enum", "choices": ["Weapon", "Armor"], "schemaType": "string"},
            {"name": "tier", "value": "2", "kind": "number", "choices": [], "schemaType": "int", "integer": True, "min": 0, "max": 6},
    ...
    "schemaIssueCount": 0,
    "saved": 1,
    "backup": "C:/fixture/ModuleData/items.xml.lexeditor.bak",
}
GAUNTLET = {
    "path": "C:/fixture/GUI/Prefabs/Test.xml",
    "relativePath": "GUI/Prefabs/Test.xml",
    "elementCount": 3,
    "elements": [
...
def inline_editor() -> str:
    ...
    fixtures = {
        "/api/module": MODULE,
        "/api/project": PROJECT,
        "/api/skills": EMPTY_SKILLS,
        "/api/effects": EMPTY_EFFECTS,
        "/api/perks": EMPTY_PERKS,
        "/api/xp-sources": EMPTY_XP,
        "/api/settings-defaults": EMPTY_SETTINGS,
        "/api/runtime-overrides": RUNTIME,
        "/api/deployment": DEPLOYMENT,
        "/api/datamap": DATA_MAP,
...
window.fetch=async function(input,options={{}}){{
  ...
  return new Response(JSON.stringify(__fixtures[path]||{{}}),{{status:200}});
    ...
    for name in (
        ...
        "editor_runtime.js",
        "editor_gauntlet.js",
        "editor_moduledata.js",
        "editor_boot.js",
    ):
        html = html.replace(
            f'<script src="/bannerlord/{name}"></script>',
...
def main() -> None:
    ...
    with sync_playwright() as playwright:
        ...
        try:
            ...
            assert request["body"]["edits"][0]["value"] == "browser_fixture"
