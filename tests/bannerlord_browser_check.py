...
const __blReplace=history.replaceState.bind(history);
history.replaceState=(s,t,u)=>{{try{{return __blReplace(s,t,u)}}catch(e){{return __blReplace(s,t)}}}};
const __blPush=history.pushState.bind(history);
history.pushState=(s,t,u)=>{{try{{return __blPush(s,t,u)}}catch(e){{return __blPush(s,t)}}}};
