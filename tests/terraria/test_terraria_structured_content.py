...
from plugins.terraria.source_text import save_source, source_file_state
...
class TerrariaStructuredContentTests(unittest.TestCase):
    def test_schema_exposes_major_content_families(self):
        ...
        self.assertEqual(
            kinds,
            {"item", "npc", "projectile", "buff", "tile", "wall", "globalItem", "globalNPC", "globalProjectile", "prefix", "rarity", "biome", "config", "command", "sceneEffect", "dust", "globalBuff", "globalTile", "globalWall", "recipe"},
        )
