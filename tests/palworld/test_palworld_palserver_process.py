...
from plugins.palworld.palserver_process import PalServerProcessError, require_stopped, running


class PalServerProcessTests(unittest.TestCase):
    @patch("plugins.palworld.palserver_process.os.name", "nt")
    @patch("plugins.palworld.palserver_process.subprocess.run")
