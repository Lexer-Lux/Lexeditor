...
def main() -> int:
    ...
    output = DEV_CACHE / "rendered" / "github-39-ff8-enemies.png"
    curve_output = DEV_CACHE / "rendered" / "github-39-ff8-enemy-curves.png"
    tables_output = DEV_CACHE / "rendered" / "github-39-ff8-enemy-tables.png"
