...
def main() -> int:
    ...
    output = ROOT / "out" / "rendered" / "github-39-ff8-enemies.png"
    curve_output = ROOT / "out" / "rendered" / "github-39-ff8-enemy-curves.png"
    tables_output = ROOT / "out" / "rendered" / "github-39-ff8-enemy-tables.png"
