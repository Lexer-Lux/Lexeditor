...
def outer_metrics(page):
    return page.evaluate("""()=>({
      ...
      main:{...(()=>{const r=document.querySelector("#main").getBoundingClientRect();return {left:r.left,right:r.right,top:r.top,bottom:r.bottom,width:r.width,height:r.height}})()}
    })""")
