...
const html=fs.readFileSync(path.join(__dirname,'../plugins/rdr2/editor.html'),'utf8');
...
const core=fs.readFileSync(path.join(__dirname,'../plugins/rdr2/core.js'),'utf8');
new vm.Script(core);
const source=core.slice(core.indexOf('let datasetLoadVersion = 0;'),core.indexOf('\nfunction noData(msg)'));
