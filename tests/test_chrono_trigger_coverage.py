...
class CoverageTests(unittest.TestCase):
    ...
    def test_data_map_describes_desktop_named_event_editing(self):
        ...
        self.assertIn("script/bank/segment memory", event_row["controls"])
        self.assertIn("PC-extended", event_row["controls"])
        self.assertIn("object/facing/property", event_row["controls"])
