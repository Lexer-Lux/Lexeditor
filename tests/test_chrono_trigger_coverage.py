...
class CoverageTests(unittest.TestCase):
    ...
    def test_data_map_describes_desktop_named_event_editing(self):
        ...
        self.assertIn("object/property", event_row["controls"])
        ...
        self.assertIn("EC is now dynamically disassembled", event_row["notes"])
        self.assertIn("1/2/3 argument bytes", event_row["notes"])
        self.assertIn("Odd doubled targets", event_row["notes"])
        self.assertIn("0x16/60/61/67/6E/8D/8E/9E/9F", event_row["notes"])
