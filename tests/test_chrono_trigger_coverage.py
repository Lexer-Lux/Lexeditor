...
class CoverageTests(unittest.TestCase):
    ...
    def test_data_map_describes_desktop_named_event_editing(self):
        ...
        self.assertIn("0x7F0000–0x7F00FF", event_row["notes"])
        self.assertIn("0x63/64/69/6B/6F", event_row["notes"])
        self.assertIn("0x3A/3D/3E/45/46/70/74/78", event_row["notes"])
        self.assertIn("0x02–0x07", event_row["notes"])
        self.assertIn("0x0A/0B/0C/7C/7D", event_row["notes"])
        self.assertIn("0x23/24/A8/A9", event_row["notes"])
        self.assertIn("0x0D/0x0E", event_row["notes"])
        self.assertIn("9A/9D/A0/A1", event_row["notes"])
        self.assertIn("D9/E2/E7/F4", event_row["notes"])
        self.assertIn("EB song volume", event_row["notes"])
        self.assertIn("29/82/C8", event_row["notes"])
        self.assertIn("coordinate bytes", event_row["notes"])
        self.assertIn("EC is dynamically disassembled", event_row["notes"])
        self.assertIn("read-only known-form semantics", event_row["notes"])
        self.assertIn("Odd doubled targets", event_row["notes"])
        self.assertIn("0x16/60/61/67/6E/27/28/8D/8E/92/9C/9E/9F", event_row["notes"])
