...
class FormulaeReworkTests(unittest.TestCase):
    ...
    def test_only_real_runtime_components_are_marked_implemented(self):
        ...
        self.assertEqual(runtime, {
            ...
            "status_infliction": "status_chance_rework",
            "status_attack": "status_chance_rework",
        })
    ...
    def test_settings_module_alias_cannot_be_shadowed_by_boolean(self):
        settings = (Path(__file__).resolve().parents[2] / "plugins/ff8/gameplay_settings.py").read_text(
            encoding="utf-8"
        )
        self.assertIn(
