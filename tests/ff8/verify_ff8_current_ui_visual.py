...
def main() -> int:
    ...
    try:
        ...
        with FF8Session({"LEXEDITOR_FF8_PROJECT": project.name}) as session:
            ...
            from tests.ff8.verify_ff8_math_visual import check_math
            ...
            cdp.eval("""(()=>{window.pywebview={api:{lexeditor_settings:async()=>({developerMode:true,developerAuthorized:true,developerLogin:'Lexer-Lux',hoverableAltClick:false,selectionHoldMs:650,tableRowsPerPage:15,panelGapPercent:1,residentHandleWidthPercent:5,mainMenuHeightPercent:9,soundEnabled:true,soundVolumePercent:50,absentGameDesaturationPercent:75,globalMessageRarity:3,loadingTransitionMinimumSeconds:1.5,updateCheckFrequency:'daily',updateCheckChoices:[{value:'daily',label:'Daily'},{value:'weekly',label:'Weekly'}],defaultValues:{hoverableAltClick:false,selectionHoldMs:650,tableRowsPerPage:15,panelGapPercent:1,residentHandleWidthPercent:5,mainMenuHeightPercent:9,soundEnabled:true,soundVolumePercent:50,absentGameDesaturationPercent:75,globalMessageRarity:3,loadingTransitionMinimumSeconds:1.5,updateCheckFrequency:'daily'},helpers:[]})}};LexeditorUI.openSettings()})()""")
