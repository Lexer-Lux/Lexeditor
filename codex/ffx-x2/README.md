...
The reader validates the signature, header hash, table boundaries, data offsets, path safety and decompressed lengths before exposing an entry.
...
- Structured gameplay/kernel record editors.
...
Synthetic/API tests prove only parser, service, project and deployment mechanics. They do not prove that a real Steam build accepts a given replacement file in-game.
