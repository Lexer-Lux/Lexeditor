...
Agent-side implementation (on master, verified by `tests/ff9/test_ff9_mod_compat.py`
and the `tests/ff9/ff9_browser_check.py` mod-compat capture) already covers:
...
- `app.py --list` and `tests/shared/test_plugin_descriptors.py` were red: FF9 declared
