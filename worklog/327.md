...
`tests/ff8/test_ff8_flare_encounter.py` now executes the actual supported EXE save
...
not bound to startup. `tests/ff8/test_ff8_flare_item.py` tests the compiled production
