...
`tests/shared/restart_browser_check.py` drives the production Blank page and HostApi against
...
tests/shared/restart_browser_check.py; tests/blank/test_blank_projects.py;
