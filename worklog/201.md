...
tests/rdr2/test_rdr2_issue201_safety_boundary.py locks the deliberately
...
entity writes). Re-ran tests/rdr2/test_rdr2_issue201_safety_boundary.py:
...
Re-ran tests/rdr2/test_rdr2_issue201_safety_boundary.py: 5 green. No new agent-side slice was owed beyond the existing contract; a safe entity-local mechanism and the game session are still owed.
