...
regeneration. Covered by tests/rdr2/test_rdr2_dead_eye_replacement.py
...
tests/rdr2/test_rdr2_dead_eye_replacement.py: 9 green. Stays actionable:
...
Re-ran tests/rdr2/test_rdr2_dead_eye_replacement.py: 9 green. No new agent-side slice was owed beyond the existing contract; selective suppression proof and the replacement session are still owed.
