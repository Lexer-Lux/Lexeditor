...
- Tests: `tests/ff7r/test_ff7r_hp_rebalance_runtime.py`,
  `tests/ff7r/test_ff7r_hp_rebalance_probe.py`,
  `tests/ff7r/test_ff7r_hp_recalc_sequence_probe.py`, bench probe tests pass (full
