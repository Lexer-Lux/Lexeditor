...
Covered by tests/rdr2/test_rdr2_core_modifiers.py (8 hermetic tests). No
...
Re-ran tests/rdr2/test_rdr2_core_modifiers.py: 8 green. No new agent-side slice was owed beyond the existing contract; the engine decrement function and the game session are still owed.
