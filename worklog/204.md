...
tests/rdr2/test_rdr2_fence_price_check.py (8 hermetic tests). No gameplay
...
Re-ran tests/rdr2/test_rdr2_fence_price_check.py: 8 green. No new agent-side slice was owed beyond the existing contract; the per-shop price hook and the comparison session are still owed.
