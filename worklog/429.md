...
- Tests: `tests/ff7r/test_ff7r_lockon_tweaks.py`, `tests/ff7r/test_ff7r_lockon_probe.py`,
  `tests/ff7r/test_ff7r_lockon_slot_asset_probe.py`,
  `tests/ff7r/test_ff7r_lockon_text_probe.py` pass (full ff7r selection: 519
