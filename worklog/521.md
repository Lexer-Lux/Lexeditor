...
- #525 — Data Map GUI contract locked (new `tests/ff9/test_ff9_datamap_gui.py`).
...
- Branch now tracks master `e0e15a63`; this session adds one repair per issue:
  ...
  `tests/ff9/test_ff9_runtime.py`), #524 credits-bundle regeneration
...
- The #525/#74 repair (`tests/ff9/test_ff9_datamap_gui.py` games-to-plugins port)
