...
Draw-check slice done on PR 506 (b338b02a): tests/ff8/test_ff8_streamlined_draw.py, 7 green. Refine tables covered (4 tests). Text-override slice done on PR 506 (c8a8183a): tests/ff8/test_ff8_kernel_text.py, 7 green, including a pinned apostrophe asymmetry (encode ' decodes U+2018, benign).
